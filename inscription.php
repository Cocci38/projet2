                ...
                <div class='card-body'>
                    <form action='validationformulaire.php' method='post'>
                        ...
                        <div class='mb-4'>
                            ...
                            <input type='password' class='form-control' id='password' placeholder='Votre mot de passe' required='required'name='password'>
                        </div>
                        <div class='mb-4'>
                            <label for='password' class='form-label'>Confirmation mot de passe</label>
                            <input type='password' class='form-control' id='password'placeholder='Retapez votre mot de passe' required='required' name='password'>
                        </div>
                        <div class='mb-4'>
