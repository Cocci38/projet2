        ...
        <div class='row mb-3'>
            ...
            <div class='col'>
                <div class='image-upload'>
                    ...
                    <?= empty($musicmodif['Sound']) ? "<input name='Sound' id='Sound' type='file' value='" . $musicmodif['Sound'] . "?> required />" : "  
                                                        <p>
            ...
            <div class='col'>
                <div class='image-upload'>
                    <label for='Cover'>
                        <?= empty($musicmodif['Cover']) ? "<img src='img\cover2.png' width='100px' />" : "<img src='" . $musicmodif['Cover'] . "'>" ?>
                    </label>
